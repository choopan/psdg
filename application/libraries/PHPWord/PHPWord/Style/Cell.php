...
class PHPWord_Style_Cell {
	...
	public function getAlign() {						//add this line
        return $this->_align;
    }
    public function setAlign($pValue = null) {			//add this line
        $this->_align = $pValue;
    }
    public function setGridSpan($pValue = null) {		//add this line
        $this->_gridSpan = $pValue;
    }
    public function getGridSpan() {						//add this line
        return $this->_gridSpan;
    }
    public function setVMerge($pValue = null) {			//add this line
        $this->_vMerge = $pValue;
    }
    public function getVMerge() {						//add this line
        return $this->_vMerge;
    }
