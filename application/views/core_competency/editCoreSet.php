...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">แก้ไขแบบประเมินสมรรณะ</h3>
            </div>
        </div>
        
        <form class="form-horizontal" action="<?php echo site_url('core_competency/saveEditCoreSet').'/'.$coreSetID; ?>" method="POST">
                ...
                <div class="panel panel-default">
					<div class="panel-heading">						
							<div class="form-group row">
									...
									<div class="col-lg-6">													
										<input id='coreset_name' type="text" class="form-control" name="coreset_name" value="<?php echo $coreSetName; ?>" required>
									</div>
							</div>
					</div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="skillTable">
								...
								?>
									<tr id="skillRow<?php echo $rindex; ?>">
                                        ...
                                        <td><input class="form-control" type="text" name="expectVal[]" value="<?php echo $se['expectVal']?>"></td>
										<td>
										<?php                                        	 
                                       		  if($rindex == 0) {
										?>										
										...
										<?php } else { ?>
												<button type="button" class="btn btn-danger" onclick="deleteSkill('<?php echo $rindex; ?>')">ลบหัวข้อสมรรณะ  </button>
										<?php } ?>																																
										</td>
                                    </tr>
								<?php	
