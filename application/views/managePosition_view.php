            ...
            <div >
                <div class="panel panel-default">
					<div class="panel-heading">
						<button type="button" class="btn btn-success" onClick="window.location.href='<?php echo site_url("manageuser/addPosition_type"); ?>'"><i class="glyphicon glyphicon-plus"></i> เพิ่มประเภทตำแหน่ง</button>
						...
						<button type="button" class="btn btn-warning" onClick="window.location.href='<?php echo site_url("manageuser/addPosition_level"); ?>'"><i class="glyphicon glyphicon-plus"></i> เพิ่มระดับ</button>
					</div>
