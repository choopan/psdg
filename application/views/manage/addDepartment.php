			...
			<div class="col-lg-11">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong>เพิ่มกรม/สำนักปลัด</strong>
					</div>
						...
						<?php }?>		
								<form action="<?php echo site_url("manageuser/addDepartmaent_save"); ?>" method="post" name="addDepartment">
									...
									<div class="row">
										<div class="form-group">
										<div class="col-lg-3">
											<input id="addNew" type="submit" class="btn btn-success" value="เพิ่ม"> <a href="<?php echo site_url("manageuser/department_view");?>" class="btn btn-primary">กลับ</a>
										</div>
										</div>
									</div>
								</form>
