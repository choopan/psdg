            ...
            <div class="col-lg-5">
                <div class="panel panel-default">
                    <div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-5">
									<button type="button" class="btn btn-warning" onClick="window.location.href='<?php echo site_url("manageindicator/viewDep/".$loop->depID); ?>'"> กลับไปหน้าแสดงตัวชี้วัดระดับกรม </button>
							</div>
						</div>
