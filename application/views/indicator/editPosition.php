								...
								<form action="<?php echo site_url("manageuser/updatePosition_save"); ?>" method="post" name="addDepartment">
									<div class="row">
										...
										<div class="form-group">
											<input type="hidden" name="id" value="<?php echo $data[0]['PWPOSITION'];?>">
                                            <label>ชื่อตำแหน่ง(ภาษาไทย) *</label>
                                            <input type="text" class="form-control" name="tposition" value="<?php echo $data[0]['PWNAME'];?>">
										</div>
										</div>
										<div class="col-lg-4">
										<div class="form-group">
											<label>ชื่อตำแหน่ง(ภาษาอังกฤษ) *</label>
                                            <input type="text" class="form-control" name="eposition" value="<?php echo $data[0]['PWENAME'];?>">
										</div>
										</div>
									</div>
									<div class="row">
