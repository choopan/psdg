		...
		<div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
						<a id="buttonadddep" href="<?php echo site_url("manageindicator/addNewIndicatorDivision");  ?>"><button type="button" class="btn btn-primary">เพิ่มตัวชี้วัดของกอง</button></a>
						<button id="buttondel2" type="button" class="btn btn-danger">ลบตัวชี้วัดที่เลือก</button>
                            <table class="display" id="dataTables-example2">
                                <thead>
                                    <tr>
