		...
		<div class="row">
            <div class="panel panel-default">
					<div class="panel-heading">
							...
							<button type="button" class="btn btn-success" onClick="window.location.href='<?php echo site_url("indicator_admin/addUser_indicator3"); ?>'"><i class="glyphicon glyphicon-plus"></i> เพิ่มผู้ใช้งาน</button>							
					</div>
