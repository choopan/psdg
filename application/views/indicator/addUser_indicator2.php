			...
			<div class="col-lg-11">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php }?>	
								<div id="show"></div>
								<form onSubmit="return check_pass()" action="<?php echo site_url("indicator_admin/indicatorUser_save2"); ?>" method="post" name="addUser">
										...
										<div class="col-lg-12">
											...
											<label>ผู้ดูแลระบบ * |</label>	
												<label class="checkbox-inline">
													<input type="radio" value="report_div"  name="admin" checked>ผู้รับผิดชอบประเด็นความสำเร็จ
												</label>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="form-group">
										<div class="col-lg-3">
											<input id="addNew" type="submit" class="btn btn-success" value="เพิ่ม"> <a href="<?php echo site_url("indicator_admin/user_indicator_view2");?>" class="btn btn-primary">กลับ</a>
										</div>
										</div>
									</div>
								</form>
