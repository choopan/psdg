		...
		<div class="row">
            <div class="panel panel-default">
					<div class="panel-heading">
							...
							<button type="button" class="btn btn-success" onClick="window.location.href='<?php echo site_url("indicator_admin/addUser_indicator"); ?>'"><i class="glyphicon glyphicon-plus"></i> เพิ่มผู้ใช้งาน</button>
							<a href="<?php echo base_url('index.php/indicator_admin/deleteAll_user').''; ?>" class="btn btn-danger" onClick='return confirm(" คุณต้องการลบทั้งหมดหรือไม่ ")'><i class="glyphicon glyphicon-minus"></i> ลบข้อมุลผู้ใช้ทั้งหมด</a>
						...
						<table class="table table-striped table-bordered table-hover">
								...
								?>
									<tr>
										...
										<td>
											<a href='<?php echo "user_del_info/".$loop['USERID']."/1"; ?>' class="btnDelete btn btn-danger btn-xs" onClick='return confirm(" คุณต้องการลบหรือไม่ ")' title="ลบข้อมูล"><span class="glyphicon glyphicon-trash"></span></a>
										</td>
                                    </tr>
							     <?php  } ?>
                                </tbody>
