            ...
            <div>
                <div class="panel panel-default">
					<div class="panel-heading">
						<button type="button" class="btn btn-outline btn-success" onClick="window.location.href='<?php echo site_url("manageuser/addDivision"); ?>'">เพิ่มกอง</button>
					</div>
