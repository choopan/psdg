<?php 
	$data['title']='แก้ไขคำรับรองการปฏิบัติราชการ  เลือกกอง';
...
?>
	...
	<?php $this->load->view('menu'); ?>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">แก้ไขคำรับรองการปฏิบัติราชการ  เลือกกอง</h3>
					<!--<div id="debug"></div>-->
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<form method="post" action="<?php echo site_url('managewarranty/update_ratification_divis'); ?>" onSubmit="return chk_add_managewarranty()">
							<input type="hidden" name="warranty_id" value="<?php echo $recip_employee[0]['warranty_id']; ?>">
							<div class="row">
								<div class="col-lg-3">
									<label>เลือกกอง <font color="red">*</font></label>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-3">
									<div class="form-group">
										<select class="form-control" name="division_id" id="division_id">
											...
											<option value="<?php echo $val['id']; ?>" <?php if($recip_employee[0]['division_id']==$val['id']) echo 'selected'; ?>> <?php echo $val['name']; ?> </option>
											<?php } ?>
										</select>
									</div>
								</div>
