...
<body>
    ...
    <form class="form-inline" role="form"  action="<?php echo site_url('person_evaluation/divExecEditActivityInfo/'.$activity['ID'].'/'.$pid."/".$userID); ?>" method="POST">            														
    <div class="modal-body">    
        ...
        <div class="form-group">            																
            ...
            <input type="text" class="form-control" name="score" style="width: 100px" value="<?php echo $activity['execscore']; ?>" >
		</div>            																	
        <div class="form-group">            																
