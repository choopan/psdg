										...
										<tr>
											...
											<td>
    											<div class="tooltip-demo">
													...
													<a data-toggle="modal" data-target="#myEditModal<?php echo $ind['ID']; ?>" href='<?php echo site_url("person_evaluation/editPersonIndicatorDetailFromExecDep/".$ind['ID']."/".$user['user_id']); ?>' class="btn btn-primary btn-xs" data-title="View" data-toggle="tooltip" data-target="#view" data-placement="top" rel="tooltip" title="แก้ไข" data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-pencil"></span></a>
													...
													<a href='<?php echo site_url("person_evaluation/deletePersonIndicatorDetailFromExecDep/".$ind['ID']."/".$user['user_id']); ?>' class="btnDelete btn btn-danger btn-xs" onClick='return confirm(" คุณต้องการลบหรือไม่ ")' title="ลบข้อมูล"><span class="glyphicon glyphicon-trash"></span></a>		
				...
				<div class="modal-dialog modal-lg">
        			<div class="modal-content">
            			...
            			<div class="modal-body">
							...
							<form class="form-inline" role="form" action="<?php echo site_url('person_evaluation/submitIndicatorFormFromExecDep/'.$user['user_id']); ?>" method="POST">
					...
					<a href="<?php echo site_url('person_evaluation/execAgreeIndicatorFromDep').  "/" . $pi_set ."/". $user['user_id'] ."/".$sumweight; ?>" type="button" class="btn btn-primary" onClick='return confirm(" คุณอนุมัติตัวชี้วัดนี้หรือไม่ ")'><span class="glyphicon glyphicon-ok"></span> อนุมัติตัวชี้วัด</a>&nbsp;&nbsp;
					<a href="<?php echo site_url('person_evaluation/execCancelIndicatorFromDep'). "/" . $pi_set; ?>" type="button" class="btn btn-danger" onClick='return confirm(" คุณต้องการไม่อนุมัติตัวชี้วัดจริงหรือไม่ ")'><span class="glyphicon glyphicon-remove"></span> ไม่อนุมัติ</a>
				</center><BR>
