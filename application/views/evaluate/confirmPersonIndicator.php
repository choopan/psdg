...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-6">
			<strong>สถานะ :</strong>&nbsp;&nbsp;<span class="label label-success">รอการพิจารณา</span>
		</div>
		<div class="col-lg-6">
			<a href="<?php echo site_url('person_evaluation/execAgreeIndicator').  "/" . $pi_set; ?>" type="button" class="btn btn-primary">อนุมัติตัวชี้วัด</a>&nbsp;&nbsp;
			<a href="<?php echo site_url('person_evaluation/execCancelIndicator'). "/" . $pi_set; ?>" type="button" class="btn btn-danger">ไม่อนุมัติ</a>		
		</div>
